  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900 flex items-center justify-center p-4">
      <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 w-full max-w-md border border-white/20">
        ...
        <p className="text-gray-300 mb-6 font-medium">Gemma 3 12B Strategy Engine</p>
          ...
          <div className="prose prose-invert prose-sm max-w-none text-gray-200">
            {loading.ai ? (
              <div className="animate-pulse space-y-4">
                ...
                <p className="text-purple-300 font-medium">Gemma 3 12B is calculating niche gaps...</p>
              </div>
            ) : recommendations ? (
              <>
                ...
                <div className="mt-8 pt-4 border-t border-white/10 flex items-center justify-between">
                  <div className="text-[10px] text-gray-500 italic max-w-md">
                    Disclaimer: Growth strategies are generated by Gemma 3 12B based on historical data. Results are not guaranteed.
                  </div>
